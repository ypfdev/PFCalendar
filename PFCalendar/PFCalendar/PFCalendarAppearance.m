...
@implementation PFCalendarAppearance


+ (instancetype)share{
    static dispatch_once_t onceToken;
    static PFCalendarAppearance *appearance;
    dispatch_once(&onceToken, ^{
        appearance = [PFCalendarAppearance new];
    });
    return  appearance;
}
...
- (void)setDefaultValues{
    ...
    self.weekDayFormat = PFCalendarWeekDayFormatSingle;
