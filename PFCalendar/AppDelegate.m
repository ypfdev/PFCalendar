...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // 创建根控制器并设为可见
    _mainVC = [[UIStoryboard storyboardWithName:@"MainVC" bundle:nil] instantiateViewControllerWithIdentifier:@"MainVC"];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"PFCalendar"];
